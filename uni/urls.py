...
urlpatterns = [
    ...
    path('/fa', views.HomeView.as_view(), name='home'), #home page
    path('', views.Home_enView.as_view(), name='home_en'), 
    path('aboutus/<str:lang>', views.AboutusView.as_view(), name='aboutus'), 
    path('logout/', views.page_logout, name='logout'),
    path('login/<str:lang>',views.LoginView.as_view(),name = 'login'), #login page
    path('login/<str:lang>/forget',views.ForgetpassView.as_view(),name = 'forget'), 
    path('login/forget/<str:message>/<str:lang>/messagef',views.MessageboxfView.as_view(),name = 'messagef'), 
    path('student/<int:student_id>/page/',views.PageView.as_view(),name = 'page'),#student page
    path('Leader/<int:leader_id>/leader/',views.LeaderView.as_view(),name = 'leader'),
    ...
    path('Boss/<int:boss_id>/boss/changepassbs',views.ChangePassbsView.as_view(),name = 'changepassbs'),
    path('Leader/<int:leader_id>/leader/changepassled',views.ChangePassledView.as_view(),name = 'changepassled'),
    ...
    path('ostad/<int:leader_id>/<str:message>/messageled',views.MessageboxledView.as_view(),name = 'messageled'),
    path('ostad/<int:boss_id>/<str:message>/messagebs',views.MessageboxbsView.as_view(),name = 'messagebs'),
    ...
    path('admin/<int:admin_id>/page2/forget2',views.Forgetpass2View.as_view(),name = 'forget2'),
    path('admin/<int:admin_id>/page2/forget2/<int:ostad_id>/forget3',views.Forgetpass3View.as_view(),name = 'forget3'),
    ...
    path('admin/<int:admin_id>/page2/barname1/barname2/<int:elam_id>/erae/nahaee',views.NahaeeView.as_view(),name = 'nahaee'),
